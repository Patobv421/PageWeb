...
<head>
  ...
  <title>Cardiovascular Drugs - HealthSelf</title>
    ...
    <div class="container-items">
        ...
        <div class="item-container">
          <div class="item-image">
            <div class="image-container">
              <img src="https://th.bing.com/th/id/OIP.86RfTSCAqtGijGRLRLaHHAHaFF?rs=1&pid=ImgDetMain" alt="Losartan">
            </div>
          </div>
          <div class="item-details">
            <div class="item-title"><h2>Losartan</h2></div>
            <div class="item-description">
              <p class="description">An angiotensin II receptor blocker used to treat high blood pressure.</p>
            </div>
            <div class="item-info">
      ...
      <div class="item">
        ...
        <div class="item-container">
          <div class="item-image">
            <div class="image-container">
              <img src="https://th.bing.com/th/id/OIP.xNh-AfSzufxhHM6X-GNr2wHaEA?rs=1&pid=ImgDetMain" alt="Amlodipine">
            </div>
          </div>
          <div class="item-details">
            <div class="item-title"><h2>Amlodipine</h2></div>
            <div class="item-description">
              <p class="description">A calcium channel blocker used to lower blood pressure and reduce chest pain (angina).</p>
            </div>
            <div class="item-info">
              <div class="info-product">
      ...
      <div class="item">
        ...
        <div class="item-container">
          <div class="item-image">
            <div class="image-container">
              <img src="https://iberofarmacos.net/wp-content/uploads/2022/03/METOPROLOL-50MG_Mesa-de-trabajo-1-scaled.jpg" alt="Metoprolol">
            </div>
          </div>
          <div class="item-details">
            <div class="item-title"><h2>Metoprolol</h2></div>
            <div class="item-description">
              <p class="description">A beta-blocker used to treat high blood pressure, chest pain, and heart failure.</p>
            </div>
            <div class="item-info">
              <div class="info-product">
