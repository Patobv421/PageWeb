...
<body>
            ...
            <div class="cards-column">
                ...
                <div class="service-card">
                    <div class="service-icon-container">
                        <img
                            src="{{ asset('images/shopping_cart.png') }}"
                            alt="Easy and Fast Shopping"
                            class="service-icon"
                        />
                    </div>
                ...
                <div class="service-card">
                    <div class="service-icon-container">
                        <img
                            ...
                            alt="Everything for Your Well-Being"
                            class="service-icon"
                        />
                    </div>
                    <div class="service-card-content">
                        ...
                        <p>
                            Find all the products you need in one place, with the
                            quality you deserve.
                        </p>
                        <a class="buy-link" href="#">Buy now →</a>
                    </div>
                ...
                <div class="service-card">
                    <div class="service-icon-container">
                        <img
                            ...
                            alt="Schedule Easily and Quickly"
                            class="service-icon"
                        />
                    </div>
                    <div class="service-card-content">
                        ...
                        <p>
                            Make your life easier by booking your appointments online
                ...
                <div class="service-card">
                    <div class="service-icon-container">
                        <img
                            ...
                            alt="Convenience and Efficiency"
                            class="service-icon"
                        />
                    </div>
                    <div class="service-card-content">
                        ...
                        <p>
                            Choose the time that suits you best and avoid long waits
        ...
        <div class="services-group">
            <div class="cards-column">
                ...
                <div class="service-card">
                    <div class="service-icon-container">
                        <img
                            src="{{ asset('images/easily_document.png') }}"
                            alt="Easily Complete Your Medical Tests"
                            class="service-icon"
                        />
                    </div>
                    <div class="service-card-content">
                        ...
                        <p>
                            Complete your medical tests with the confidence of trusted
                            professionals.
                        </p>
                ...
                <div class="service-card">
                    <div class="service-icon-container">
                        <img
                            ...
                            alt="Quick and Reliable Results"
                            class="service-icon"
                        />
                    </div>
                    <div class="service-card-content">
                        ...
                        <p>
                            Access your results quickly through our platform, designed
                            to provide convenience and reliability at all times.
                        </p>
                        <a class="buy-link" href="#">View details →</a>
                    </div>
                </div>
    ...
    <section class="why-healthself">
        ...
        <div class="why-container">
            ...
            <p>
                When you join HealthSelf, our goal is to provide you with access
                to certified healthcare professionals tailored to your needs and
                preferences. We have doctors, specialists, and wellness experts
                ready to support you every step of the way toward a healthier life.
            </p>
    ...
    <section class="our-specialists">
        ...
        <div class="specialists-container">
            ...
            <div class="specialist-card">
                <img
                    src="{{ asset('images/neurotology.png') }}"
                    alt="Doctor Alanea Quiñones"
            ...
            <div class="specialist-card">
                <img
                    src="{{ asset('images/hiperbaric.png') }}"
                    alt="Doctor Rick Sanchez"
                    class="specialist-image"
                />
            ...
            <div class="specialist-card">
                <img
                    src="{{ asset('images/placental.png') }}"
                    alt="Doctor David Medrano"
                    class="specialist-image"
                />
        ...
        <div class="footer-content">
            ...
            <div class="footer-col brand-col">
                ...
                <p>
                    ...
                    and appointment scheduling, aided by a chatbot that analyzes results.
                </p>
                <span>Medical</span>
            </div>

            <!-- Columna 2: Helpfull Link -->
